...
To deploy Træfik to your cluster start by submitting the DaemonSet to the cluster with `kubectl`:
...
Now lets check if our DaemonSet was successful.
...
Instead of installing Træfik via a DaemonSet, you can also use the Træfik Helm chart.
